...
export default function PythonSvg(props: ISvgProps) {
  const {
    height = 32,
    width = 32,
    fill = 'none',
  ...
  return (
    <svg
      ...
      <linearGradient
        ...
        x2={12991.0264}
        y2={-27073.4023}
        gradientTransform="matrix(9.2563 0 0 -9.3468 -119299.578 -252400.031)">
        <stop offset={0} stopColor="#5ca0d5" />
        <stop offset={1} stopColor="#316a99" />
      </linearGradient>
      <path
        d="M908.4.3c-52.7 0-103.7 4.9-148.1 13.2-131.6 23-154.7 70.8-154.7 161.3v118.5H915v39.5H490.4c-88.9 0-167.8 54.3-192.5 156.3-28 118.5-29.6 190.9 0 314.3 21.4 92.2 74.1 156.3 164.6 156.3h107V818.2c0-102 88.9-192.5 192.5-192.5h307.7c85.6 0 154.7-70.8 154.7-158V173.1c0-83.9-70.8-146.5-154.7-161.3C1015.3 3.6 961-1.3 908.4.3zM740.5 94.1c31.3 0 57.6 26.3 57.6 59.2s-26.3 59.2-57.6 59.2-57.6-26.3-57.6-59.2 24.7-59.2 57.6-59.2z"
        fill="url(#SVGID_1_)"
      />
      <linearGradient
        id="SVGID_2_"
        ...
        y2={-27074.5391}
        gradientTransform="matrix(9.2563 0 0 -9.3468 -119299.578 -252400.031)">
        <stop offset={0} stopColor="#ffd43e" />
      ...
      <path
        className="st0"
        d="M1973 1767.7h9.9v-60.9h23v-8.2H1950v8.2h23v60.9zm42.8 0h8.2v-55.9l18.1 55.9h9.9l18.1-55.9v55.9h9.9v-69.1h-11.5l-21.4 59.2-18.1-59.2h-13.2v69.1z"
      />
      <radialGradient
        id="SVGID_3_"
        cx={-83039.6641}
        cy={-13866.3984}
        r={20.3396}
        gradientTransform="matrix(0 -3.9477 -17.3558 0 -239744.531 -326357.719)"
        gradientUnits="userSpaceOnUse">
        <stop offset={0} stopColor="#b8b8b8" stopOpacity={0.498} />
        <stop offset={1} stopColor="#7f8080" stopOpacity={0} />
      </radialGradient>
      <path
        d="M1332.9 1471.5c0 44.4-185.9 80.6-414.7 80.6s-414.7-36.2-414.7-80.6c0-44.4 185.9-80.6 414.7-80.6s414.7 36.1 414.7 80.6z"
        opacity={0.444}
        fill="url(#SVGID_3_)"
      />
    </svg>
